...
config="configs/stage-c4/factorized-warmstart-sft-v1.toml"
...
base_merged="runs/stage-c4/base-merged-step23"
sft_run="runs/stage-c4/warmstart-sft-v1"
selection_root="runs/stage-c4/warmstart-selection-v1"
selected_root="runs/stage-c4/warmstart-selected-v1"
...
mkdir -p "$XDG_CONFIG_HOME" "$selection_root/candidates" \
  "$selection_root/work"
...
cleanup_candidate_merged() {
  local expected="$repo_root/runs/stage-c4/warmstart-selection-v1/work/merged-candidate"
