"""Build or strictly check non-authorizing Prime inventory v5 artifacts."""
...
from redco.analysis.stage_d_v13_prime_inventory_v5 import (  # noqa: E402
    AUDIT_RELATIVE,
...
def main(argv: list[str] | None = None) -> int:
    ...
    payloads = build_prime_inventory_v5_artifacts(repository)
    ...
    hashes = verify_prime_inventory_v5_artifacts(repository, output_root)
