...
config_path="${1:?usage: run_stage_c2_campaign_arm.sh CONFIG OUTPUT_DIR}"
output_dir="${2:?usage: run_stage_c2_campaign_arm.sh CONFIG OUTPUT_DIR}"
...
export UV_PROJECT_ENVIRONMENT="${REDCO_UV_ENVIRONMENT:-/workspace/.venv-prime-stage-c2}"
export UV_CACHE_DIR="${REDCO_UV_CACHE_DIR:-/workspace/.uv-cache-prime-stage-c2}"
