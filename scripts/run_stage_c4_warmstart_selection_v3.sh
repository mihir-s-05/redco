...
config="configs/stage-c4/factorized-warmstart-sft-v3.toml"
...
base_merged="runs/stage-c4/base-merged-step23-v3"
sft_run="runs/stage-c4/warmstart-sft-v3"
selection_root="runs/stage-c4/warmstart-selection-v3"
selected_root="runs/stage-c4/warmstart-selected-v3"
...
cleanup_candidate_merged() {
  local expected="$repo_root/runs/stage-c4/warmstart-selection-v3/work/merged-candidate"
...
# This gate maps directly onto the v2 defect: every SFT prompt and target must
# be token-identical to the frozen live scorer under the campaign renderer.
