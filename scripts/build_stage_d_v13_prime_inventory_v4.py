"""Build or strictly check non-authorizing Prime inventory v4 artifacts."""
...
from redco.analysis.stage_d_v13_prime_inventory_v4 import (  # noqa: E402
    AUDIT_RELATIVE,
...
def main(argv: list[str] | None = None) -> int:
    ...
    payloads = build_prime_inventory_v4_artifacts(repository)
    ...
    hashes = verify_prime_inventory_v4_artifacts(repository, output_root)
